...
/* 0x01D6 */ DEFINE_ACTOR(Obj_Warp2block, ACTOR_OBJ_WARP2BLOCK, ACTOROVL_ALLOC_NORMAL, "Obj_Warp2block")
             ...
             DEFINE_ACTOR(Molly_npc, ACTOR_MOLLY_NPC, ACTOROVL_ALLOC_NORMAL, "Molly_npc")
             DEFINE_ACTOR(Milk_Malon, ACTOR_MILK_MALON, ACTOROVL_ALLOC_NORMAL, "Milk_Malon")
             DEFINE_ACTOR(Player_Geldb, ACTOR_PLAYER_GELDB, ACTOROVL_ALLOC_NORMAL, "Player_Geldb")
DEFINE_ACTOR(En_Spectral_Fist, ACTOR_EN_SPECTRAL_FIST, ACTOROVL_ALLOC_NORMAL, "En_Spectral_Fist")
DEFINE_ACTOR(En_Aevumtulip, ACTOR_EN_AEVUMTULIP, ACTOROVL_ALLOC_NORMAL, "En_Aevumtulip")
DEFINE_ACTOR(En_Okuta_Sw97, ACTOR_EN_OKUTA_SW97, ACTOROVL_ALLOC_NORMAL, "En_Okuta_Sw97")
DEFINE_ACTOR(En_Dekustickrefill, ACTOR_EN_DEKUSTICKREFILL, ACTOROVL_ALLOC_NORMAL, "En_Dekustickrefill")